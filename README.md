...
Download the Windows installer directly: [**Vortex-Optimizer-1.0.0-setup.exe**](./Vortex-Optimizer-1.0.0-setup.exe).

## Install

1. Download `Vortex-Optimizer-1.0.0-setup.exe` from this repository.
